# Pulse Music Theme Creation Guide

Welcome to the Pulse Music Theme Guide! This document explains how to create, style, and upload custom themes for Pulse Music.

## Getting Started

Themes in Pulse Music are essentially CSS snippets that override the default CSS variables (custom properties). You can create a theme by defining these variables inside a `:root` block.
...
2.  **Author Website**: Optionally provide a link to your website.
    - _Note:_ If you have a Pulse Music profile, your name will automatically link to it.
