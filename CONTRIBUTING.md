...
Thank you for your interest in contributing to Pulse Music! This guide will help you get started with development, understand our codebase, and follow our contribution workflow.
...
> :warning:: If we can verify that a Pull Request is just unvetted AI/Vibecoded Work, **it will be automatically closed without review.** If you can't explain your code, it doesn't belong in Pulse Music.

### No Hard Feelings

If we end up closing your Pull Request, please don't feel bad about it! We **really appreciate** you taking the time to help out with Pulse Music.
...
- **GitHub Pages** (served from `/pulse music/`)
...
Thank you for contributing to Pulse Music!
