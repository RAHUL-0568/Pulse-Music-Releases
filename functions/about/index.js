export async function onRequest(context) {
    ...
    if (isBot) {
        ...
        const metaHtml = `
            ...
            <head>
                <meta charset="UTF-8">
                <title>Pulse Music Music | About</title>
