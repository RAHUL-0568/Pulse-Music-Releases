    ...
    if (isBot && username) {
        try {
            ...
            if (profile) {
                ...
                let description = escapeHtml(profile.about || `View ${rawDisplayName}'s profile on Pulse Music.`);
                ...
                const imageUrl = escapeHtml(profile.avatar_url || 'https://pulse music.tf/assets/appicon.png');
