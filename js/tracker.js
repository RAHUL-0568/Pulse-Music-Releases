    ...
    return `
        <div class="card" data-tracker-project-id="${encodeURIComponent(era.name)}" data-sheet-id="${sheetId}" style="cursor: pointer;">
            <div class="card-image-wrapper">
                <img crossorigin="anonymous" referrerpolicy="no-referrer" src="${era.cover_art || '/image.png'}"
...
export async function renderTrackerProjectPage(sheetId, projectName, container, _ui) {
    ...
    imageEl.src = era.cover_art || '/image.png';
...
export async function renderUnreleasedPage(container) {
    ...
    artistsData.forEach((artist) => {
        ...
        artistCard.innerHTML = `
            <div class="card-image-wrapper">
                <img crossorigin="anonymous" referrerpolicy="no-referrer" class="card-image" src="${coverImage}" alt="${artist.name}" loading="lazy" onerror="this.src='/image.png'">
            </div>
            <div class="card-info">
