...
function toggleTrackSelection(trackItem, ctrlHeld, shiftHeld) {
    ...
    if (ctrlHeld) {
        ...
        const parentList = trackItem.closest('.track-list') || trackItem.closest('#main-content') || trackItem.parentElement || document;
        ...
        if (
            ...
            if (isSearch) {
                ...
                if (trackList.length > 0) {
                    ...
                    player.setQueue(trackList, startIndex !== -1 ? startIndex : 0);
