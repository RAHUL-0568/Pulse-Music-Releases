...
export const wrapTidalUrl = (url) => {
    ...
    return url
        .replace('https://api.tidal.com/v1', '/pm-catalog')
        .replace('https://openapi.tidal.com/v2', '/pm-catalog-v2')
        .replace('https://openapi.tidal.com', '/pm-catalog-v2')
        .replace('https://api.tidal.com', '/pm-catalog');
};
